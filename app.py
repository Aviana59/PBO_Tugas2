...
@app.route('/')
def index():
    pegawai_tetap = PegawaiTetap("Amira", "12345", "A", 5000000)
    pegawai_harian = PegawaiHarian("Anin", "67890", "B", 120, 5000)
    pegawai_kontrak = PegawaiKontrak("Dita", "54321", "C", 6, 2000000)
